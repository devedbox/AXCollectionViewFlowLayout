#
#  Be sure to run `pod spec lint AXCollectionViewFlowLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/devedbox/AXCollectionViewFlowLayout.git", :tag => s.version }
  ...
  s.source_files  = "AXCollectionViewFlowLayout/AXCollectionViewFlowLayout/*.{h,m}"
